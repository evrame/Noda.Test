                ...
                Configure<AbpVirtualFileSystemOptions>(options =>
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<TestDomainSharedModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Noda.Test.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<TestDomainModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Noda.Test.Domain"));
                    options.FileSets.ReplaceEmbeddedByPhysical<TestApplicationContractsModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Noda.Test.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<TestApplicationModule>(
                        Path.Combine(hostingEnvironment.ContentRootPath,
                            $"..{Path.DirectorySeparatorChar}Noda.Test.Application"));
                });
            }
        }
